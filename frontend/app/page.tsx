  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <header className="mb-10 border-b border-neutral-200 pb-8">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900">LEVERAGE</h1>
        <p className="mt-2 text-base text-neutral-500">Negotiation memory for procurement.</p>
      </header>
      {vendors.length === 0 ? (
